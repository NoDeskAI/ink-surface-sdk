...
import { clampNormBBox, markLocationObjectRefs } from '../../knowledge/builder';
...
const visibleTool = (s: PersistedStroke): boolean => s.tool === 'pen' || s.tool === 'aipen' || s.tool === 'highlighter' || s.tool === 'underline';
