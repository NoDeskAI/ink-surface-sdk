...
const ICONS: Record<string, string> = {
  ...
  underline: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M6 19h12"/><path d="M8 5v6a4 4 0 0 0 8 0V5"/></svg>',
